...
class Registration:
    ...
    def estimate(self, src, dst):
        """Estimate rigid trasnforamtion R,T
       
        Input
            src : Nx3 float numpy array
            dst : Nx3 float numpy arry
        Output
            R,T matrices
        
        """
        self.solver.solve(src.T, dst.T)
...
if __name__ == "__main__":
    ...
    print("s shape: ", src.shape)
    print("s00 type: ", type(src[0][0]))
    print("d shape: ", dst.shape)
